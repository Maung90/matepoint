      ...
      <div class="row align-items-center">
        <div class="col-xl-6 p-4">
          <div class="hero-content my-11 my-xl-0">
            ...
            data-aos-delay="200" data-aos-duration="1000"><i class="ti ti-rocket text-secondary fs-6"></i>Konsultasi Tepat, Solusi Cepat</h6>
      ...
      <div class="col-lg-6">
        <div class="text-center" data-aos="fade-up" data-aos-delay="600" data-aos-duration="1000"> 
          <h2 class="fs-7 text-center mb-4 mb-lg-9 fw-bolder">
            Apapun Masalahnya, <span class="text-primary">Matepoint</span> Solusinya
            <br>
      ...
      <div class="tab-content" id="nav-tabContent">
        ...
        <div class="row">
          ...
          <div class="text-center mb-5">
            <i class="d-block ti ti-hearts text-primary fs-10"></i> 
            <p class="mb-0 text-dark">Kesehatan Mental.</p>
          </div>
        </div>
        <div class="col-sm-6 col-md-4 col-lg-3" data-aos="fade-up" data-aos-delay="800"
        data-aos-duration="1000">
        <div class="text-center mb-5">
          <i class="d-block ti ti-user-up text-primary fs-10"></i> 
          <p class="mb-0 text-dark">Pengembangan Diri.</p>
        </div>
      </div> 
      <div class="col-sm-6 col-md-4 col-lg-3" data-aos="fade-up" data-aos-delay="800"
      data-aos-duration="1000">
      <div class="text-center mb-5">
        <i class="d-block ti ti-pig-money text-primary fs-10"></i> 
        <p class="mb-0 text-dark">Kemerdekaan Finansial.</p>
      </div>
    </div> 
    <div class="col-sm-6 col-md-4 col-lg-3" data-aos="fade-up" data-aos-delay="800"
    data-aos-duration="1000">
    <div class="text-center mb-5">
      <i class="d-block ti ti-user-exclamation text-primary fs-10"></i> 
      <p class="mb-0 text-dark">Kesehatan Seksual.</p>
    </div>
  </div> 
  <div class="col-sm-6 col-md-4 col-lg-3" data-aos="fade-up" data-aos-delay="800"
  data-aos-duration="1000">
  <div class="text-center mb-5">
    <i class="d-block ti ti-gavel text-primary fs-10"></i> 
    <p class="mb-0 text-dark">Konsultasi & Dukungan Hukum.</p>
  </div>
</div> 
<div class="col-sm-6 col-md-4 col-lg-3" data-aos="fade-up" data-aos-delay="800"
data-aos-duration="1000">
<div class="text-center mb-5">
  <i class="d-block ti ti-pill text-primary fs-10"></i> 
  <p class="mb-0 text-dark">Kosmetik & Obat-obatan.</p>
</div>
</div> 
<div class="col-sm-6 col-md-4 col-lg-3" data-aos="fade-up" data-aos-delay="800"
data-aos-duration="1000">
<div class="text-center mb-5">
  <i class="d-block ti ti-briefcase text-primary fs-10"></i> 
  <p class="mb-0 text-dark">Pendidikan & Karir.</p>
</div>
</div> 
<div class="col-sm-6 col-md-4 col-lg-3" data-aos="fade-up" data-aos-delay="800"
data-aos-duration="1000">
<div class="text-center mb-5">
  <i class="d-block ti ti-businessplan text-primary fs-10"></i> 
  <p class="mb-0 text-dark">Konsultasi Bisnis.</p>
</div>
</div> 
<div class="col-sm-6 col-md-4 col-lg-3" data-aos="fade-up" data-aos-delay="800"
data-aos-duration="1000"> 
...
data-aos-duration="1000">
<div class="text-center mb-5">
  <i class="d-block ti ti-medical-cross text-primary fs-10"></i> 
  <p class="mb-0 text-dark">Kesejahteraan Spiritual.</p>
</div>
</div> 
<div class="col-sm-6 col-md-4 col-lg-3" data-aos="fade-up" data-aos-delay="800"
data-aos-duration="1000">
<div class="text-center mb-5">
  ...
  <p class="mb-0 text-dark">Gizi & Kecantikan.</p>
</div>
</div> 
<div class="col-sm-6 col-md-4 col-lg-3" data-aos="fade-up" data-aos-delay="800"
data-aos-duration="1000"> 
  ...
  <div class="container">
    <div class="row justify-content-between">
      <div class="col-lg-7 col-xl-5 pt-lg-5 mb-5 mb-lg-0">
        <h2 class="fs-12 text-white text-center text-lg-start fw-bolder mb-8"> Konsultasikan permasalahan Anda dan temukan jawaban dari para talent dan konsultan terkemuka.</h2>
      ...
      <div class="col-lg-5 col-xl-5">
        <div class="text-center text-lg-end">
          <img src="{{ asset('dist/images/backgrounds/business-woman-checking-her-mail.png') }}" 
          class="img-fluid">
        </div>
      </div>
    </div>
