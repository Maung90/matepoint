                  ...
                  <ul class="chat-users" style="height: calc(100vh - 496px)" data-simplebar>
                    ...
                    <li>
                      <a href="javascript:void(0)" class="px-4 py-3 bg-hover-light-black d-flex align-items-start justify-content-between chat-user" id="chat_user_3" data-user-id="3">
                        <div class="d-flex align-items-center">
                          <span class="position-relative">
                            <img src="{{ asset('assets/images/profile/user-8.jpg') }}" alt="user-8" width="48" height="48" class="rounded-circle" />
                    ...
                    <li>
                      <a href="javascript:void(0)" class="px-4 py-3 bg-hover-light-black d-flex align-items-start justify-content-between chat-user" id="chat_user_4" data-user-id="4">
                        <div class="d-flex align-items-center">
                          <span class="position-relative">
                            <img src="{{ asset('assets/images/profile/user-4.jpg') }}" alt="user-4" width="48" height="48" class="rounded-circle" />
                            <span class="position-absolute bottom-0 end-0 p-1 badge rounded-pill bg-success">
                              <span class="visually-hidden">New alerts</span>
                            </span>
                          </span>
                        ...
                        <div class="offcanvas-body p-9">
                          <div class="media-chat mb-7">
                            <div class="row">
                              <div class="col-4 px-1">
                                <div class="rounded-1 overflow-hidden mb-2"><img src="{{ asset('assets/images/products/product-1.jpg') }}" alt="" class="w-100"></div>
                              </div>
                              <div class="col-4 px-1">
                                <div class="rounded-1 overflow-hidden mb-2"><img src="{{ asset('assets/images/products/product-2.jpg') }}" alt="" class="w-100"></div>
                              </div>
                              <div class="col-4 px-1">
                                <div class="rounded-1 overflow-hidden mb-2"><img src="{{ asset('assets/images/products/product-3.jpg') }}" alt="" class="w-100"></div>
                              </div>
                              <div class="col-4 px-1">
                                <div class="rounded-1 overflow-hidden mb-2"><img src="{{ asset('assets/images/products/product-4.jpg') }}" alt="" class="w-100"></div>
                              </div>
                              <div class="col-4 px-1">
                                <div class="rounded-1 overflow-hidden mb-2"><img src="{{ asset('assets/images/products/product-1.jpg') }}" alt="" class="w-100"></div>
                              </div>
                          ...
                          <div class="files-chat">
                            ...
                            <a href="javascript:void(0)" class="hstack gap-3 file-chat-hover justify-content-between mb-9">
                              <div class="d-flex align-items-center gap-3">
                                <div class="rounded-1 bg-light p-6">
                                  <img src="{{ asset('assets/images/chat/icon-adobe.svg') }}" alt=""  width="24" height="24">
                                </div>
                                <div>
                            ...
                            <a href="javascript:void(0)" class="hstack gap-3 file-chat-hover justify-content-between mb-9">
                              <div class="d-flex align-items-center gap-3">
                                <div class="rounded-1 bg-light p-6">
                                  <img src="{{ asset('assets/images/chat/icon-figma.svg') }}" alt=""  width="24" height="24">
                                </div>
                                <div>
                            ...
                            <a href="javascript:void(0)" class="hstack gap-3 file-chat-hover justify-content-between mb-9">
                              <div class="d-flex align-items-center gap-3">
                                <div class="rounded-1 bg-light p-6">
                                  <img src="{{ asset('assets/images/chat/icon-chrome.svg') }}" alt=""  width="24" height="24">
                                </div>
                                <div>
                            ...
                            <a href="javascript:void(0)" class="hstack gap-3 file-chat-hover justify-content-between mb-9">
                              <div class="d-flex align-items-center gap-3">
                                <div class="rounded-1 bg-light p-6">
                                  <img src="{{ asset('assets/images/chat/icon-zip-folder.svg') }}" alt=""  width="24" height="24">
                                </div>
                                <div>
                            ...
                            <a href="javascript:void(0)" class="hstack gap-3 file-chat-hover justify-content-between">
                              <div class="d-flex align-items-center gap-3">
                                <div class="rounded-1 bg-light p-6">
                                  <img src="{{ asset('assets/images/chat/icon-javascript.svg') }}" alt=""  width="24" height="24">
                                </div>
                                <div>
